<template>
    <jet-form-section @submitted="updatePassword">
        ...
        <template #description>
            Proteja sua conta com uma senha longa, misturando letras e números e que seja fácil de se lembrar. Combine uma senha segura com autenticação em 2 fatores.
        </template>
