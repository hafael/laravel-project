<template>
    <jet-action-section>
        ...
        <template #description>
            Encerre permanentemente a sua conta
        </template>
        ...
        <template #content>
            ...
            <jet-dialog-modal :show="confirmingUserDeletion" @close="closeModal">
                ...
                <template #content>
                    Tem certeza que deseja excluir sua conta? Depois que sua conta for removida, todos os seus recursos e dados serão excluídos permanentemente. Digite sua senha para confirmar que deseja excluir permanentemente sua conta.
